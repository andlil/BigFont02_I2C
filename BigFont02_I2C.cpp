...
BigFont02_I2C::BigFont02_I2C(LiquidCrystal_I2C* lcd) {
	_lcd = lcd;
}

//************************************************************************
//* generate custom characters
void BigFont02_I2C::begin() {
...
int BigFont02_I2C::writechar(int y, int x, char c) {
int		offset;
int		i;
char	b;
boolean	specialCase;
...
//*   y       yposition or column
//*   x       xposition or row
void BigFont02_I2C::clear(int y, int x)
{
  _lcd->setCursor(y,x);
  _lcd->print("   ");
...
void BigFont02_I2C::writeint(int y, int x, int n, byte d, bool l)
{
